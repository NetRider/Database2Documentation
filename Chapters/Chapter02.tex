...
\begin{enumerate}
	...
	\begin{figure}[h]
		...
		\begin{minipage}[t]{0.3\linewidth}
			\centering
			\includegraphics[width=\textwidth]{images/roma}
		...
		\begin{minipage}[t]{0.3\linewidth}
			\centering
			\includegraphics[width=\textwidth]{images/lazio}
		...
		\begin{minipage}[t]{0.3\linewidth}
			\centering
			\includegraphics[width=0.8\textwidth]{images/italia}
	...
	\begin{figure}[h]
		...
		\begin{minipage}[t]{0.30\linewidth}
			\centering
			\includegraphics[width=\textwidth]{images/station}
	...
	\begin{figure}[h]
		...
		\begin{minipage}[t]{0.30\linewidth}
			\centering
			\includegraphics[width=\textwidth]{images/NearestZone}
		...
		\begin{minipage}[t]{0.30\linewidth}
			\centering
			\includegraphics[width=\textwidth]{images/cnz}
	...
	\begin{figure}[h]
		...
		\begin{minipage}[t]{0.30\linewidth}
			\centering
			\includegraphics[width=\textwidth]{images/ni}
		...
		\begin{minipage}[t]{0.30\linewidth}
			\centering
			\includegraphics[width=\textwidth]{images/zf}
			\caption{ 
