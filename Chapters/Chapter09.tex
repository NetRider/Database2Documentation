...
\begin{table}[H]
	...
	\begin{tabular}{|c|c|c|c|}
		...
		tratte                  & \begin{tabular}[c]{@{}c@{}}Entità relativa ai vari segmenti che \\ compongono le linee ferroviarie\end{tabular}                                                 & \begin{tabular}[c]{@{}c@{}}gid \\ id\_route\\ geom\end{tabular}           & gid                     \\ \hline
		points    & \begin{tabular}[c]{@{}c@{}}Entità relativa ai punti che \\ costituiscono le tratte.\end{tabular}                                     & \begin{tabular}[c]{@{}c@{}}gid \\ tratta\_id\\ geom\end{tabular}     & gid                     \\ \hline
		exposure\_tratte         & \begin{tabular}[c]{@{}c@{}}Entità relativa all'esposizione al rischio \\ di frana da parte di un segmento che \\ compone una linea ferroviaria \end{tabular}  & \begin{tabular}[c]{@{}c@{}}gid \\ id\_tratta\\ exposure\end{tabular}          & gid                     \\ \hline
		exposure\_points       & \begin{tabular}[c]{@{}c@{}}Entità relativa all'esposizione al rischio \\ frana dei punti che compongono le tratte\end{tabular}                                        & \begin{tabular}[c]{@{}c@{}}gid\\ id\_point\\ exposure\end{tabular} & id                      \\ \hline
...
\begin{table}[h] \scriptsize
	...
	\begin{tabular}{|c|c|c|c|}
		...
		\multicolumn{1}{|l|}{} & \multicolumn{1}{l|}{}                                                                                                                                                                       & \multicolumn{1}{l|}{}                                                                                                                                               & \multicolumn{1}{l|}{} \\ \hline
		hanno associati           & \begin{tabular}[c]{@{}c@{}}La seguente relazione evidenzia che\\ un punto o una tratta può avere associato un valore\\ di exposure. \end{tabular} & \begin{tabular}[c]{@{}c@{}}exposure\_points\textless\textgreater      points\\ tratte\textless\textgreater exposure\_tratte\end{tabular} & nessuno               \\ \hline
		Sono costituiti           & \begin{tabular}[c]{@{}c@{}}La seguente relazione evidenzia che una route \\ può essere associata con N tratte. Una tratta\\ può appartenere ad una sola route.\\ Una tratta può essere costituita da \\ n punti, un punto appartiene ad \\ una sola tratta\end{tabular} & \begin{tabular}[c]{@{}c@{}}  railway\_routes\textless\textgreater tratte \\ points \textless\textgreater tratte      \end{tabular}                                                                                               & nessuno               \\ \hline
	\end{tabular}
...
\begin{figure}[H]
	...
	%ExposurePoints
	\node (ExposurePoints) [process1] {exposure\_points};
	\node (IdExposurePoint) [idEntita, below of= ExposurePoints,yshift = 1cm,xshift= -1cm] {};
	\node (IdPoint) [attributo, below of= ExposurePoints,yshift = 1cm,xshift= 1cm] {};
	...
	%Point	
	\node (Points) [process1, right of= Relazione, xshift= 2.5cm] {points};
	\node (IdPoints) [idEntita, above of= Points,yshift = -1cm,xshift= -1cm] {};
	\node (IDTratte) [attributo, above of= Points,yshift = -1cm,xshift= 1cm] {};
	\node (GeomPoints) [attributo, right of = Points,xshift = 0.5cm] {};
	
	%Relazione2
	\node (Relazione2) [relazione,below of=Points,yshift=-1cm]{Sono Costituiti};
	%Tratte
	\node (Tratte) [process1, below of= Relazione2, yshift=-1cm] {tratte};
	\node (IdTratta) [idEntita, below of= Tratte,yshift = 1cm,xshift= -1cm] {};
	\node (IdRoute) [attributo, below of= Tratte,yshift = 1cm,xshift= 1cm] {};
	...
	%ExposureTratte
	\node (RailwayRoutesExposure) [process1 , left of = Relazione4,xshift=-2.5cm] {exposure\_tratte};
	\node (IdRailwayRoutesExposure) [idEntita, below of= RailwayRoutesExposure,yshift = 1cm,xshift= -1cm] {};
	\node (idTratte) [attributo, below of= RailwayRoutesExposure,yshift = 1cm,xshift= 1cm] {};
	...
	\draw [line] (ExposurePoints.south) -| node[anchor=east,yshift = -0.5cm] {id\_point}(IdPoint.north);
	...
	\draw [line] (Points.north) -| node[anchor=west,yshift = 0.5cm,xshift= 0.3cm] {id\_tratta}(IDTratte.south);
	...
	\draw [line] (Tratte.south) -| node[anchor=west,yshift = -0.5cm,xshift=0.1cm] {id\_route}(IdRoute.north);
	...
	\draw [line] (RailwayRoutesExposure.south) -| node[anchor=east,yshift = -0.5cm] {id\_tratta}(idTratte.north);
	\draw [line] (RailwayRoutesExposure.west) -| node[anchor=north,yshift= 0.7cm,xshift=-0.2cm] {exposure}(ExposureRailwayRoutes.east);
