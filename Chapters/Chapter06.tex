...
\begin{table}[h]
	...
	\begin{tabular}{|c|c|c|c|c|c|}
		\hline
		\multicolumn{2}{|c|}{\multirow{2}{*}{}}                                                                        & \multicolumn{3}{c|}{\textbf{Classi di appartenenza Predette}}                 & \multirow{2}{*}{Totale}  \\ \cline{3-5}
		\multicolumn{2}{|c|}{}                                                                                         & Classe 1                 & Classe 2                 & Classe 3                 &                          \\ \hline
		\multirow{3}{*}{\textbf{\begin{tabular}[c]{@{}c@{}}Classi di \\ Appartenenza\\ Reali\end{tabular}}} & Classe 1 & N(1,1)                   & N(1,2)                   & N(1,3)                   & $T_{R1}$ \\ \cline{2-6} 
...
\begin{table}[]
	...
	\begin{tabular}{|c|c|c|c|c|}
		...
		\multirow{2}{*}{\textbf{\begin{tabular}[c]{@{}c@{}}Classi di appartenenza\\ reale\end{tabular}}} & Classe Generica    & VP                          & FN                             & P = VP + FN             \\ \cline{2-5} 
...
\begin{table}[h]
	...
	\begin{tabular}{|c|c|c|c|}
		\hline
		\multicolumn{1}{|l|}{\cellcolor[HTML]{FFFFFF}} & \cellcolor[HTML]{32CB00}Classe a rischio di pericolosità bassa & \cellcolor[HTML]{FFFE65}Classe a rischio di pericolosità medio & \cellcolor[HTML]{FE0000}Classe a rischio di pericolosità alto \\ \hline
...
I risultati appena discussi confermano la bontà del metodo proposto. Ciò nonostante è stata eseguita indagine approfondita sulle stazioni la cui classificazione risulta errata. L'obiettivo è quello di comprendere se ci sono ulteriori margini di miglioramento del metodo.
