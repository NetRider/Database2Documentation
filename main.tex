...
\include{Chapters/Chapter01} % Indroduzione
\include{Chapters/Chapter02} % Notazione
\include{Chapters/Chapter03} %Metodo
\include{Chapters/Chapter04} %Pseudo codice
\include{Chapters/Chapter08}% Progettazione basi dati
\include{Chapters/Chapter05} %caso di studio
\include{Chapters/Chapter06}%Validazione
\include{Chapters/Chapter07}% Estenzione del metodo linee
\include{Chapters/Chapter09}%estenzione basi dati
\include{Chapters/Chapter11} % estensione caso studio
\include{Chapters/Chapter10}% Validazione del metodo linee
...
\include{Chapters/Chapter0C} % Appendix B - empty template
